...
CardEssential is a basic tool mod that provides basic functions to modify the game content. Currently you can view all **Stats** of the game, and you can modify, favorite and lock them.
