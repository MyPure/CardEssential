...
public class StatCell : ICell
{
    ...
    public GameObject CreateContent(GameObject parent)
    {
        ...
        UIFactory.SetLayoutGroup<VerticalLayoutGroup>(UIRoot, false, false, true, true, 5, 2, 2, 2, 2, childAlignment: TextAnchor.UpperLeft);
        ...
        // Foldout content
        m_StatCellDetail = new StatCellDetail(HandleValueApplyClick, HandleRateApplyClick, HandleValueResetClick, HandleRateResetClick);
    ...
    public void SetStat(StatPack statPack)
    {
        ...
        var status = statPack.CurrentStatuses.FirstOrDefault();
